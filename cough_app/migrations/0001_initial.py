# Generated by Django 4.0.4 on 2022-06-30 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='cough_app.doctor')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='cough_app.hospital')),
            ],
        ),
        migrations.CreateModel(
            name='Prescription',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField()),
                ('prescription', models.FileField(null='True', upload_to='File')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cough_app.doctor')),
            ],
        ),
        migrations.CreateModel(
            name='Cough',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cough', models.FileField(null='True', upload_to='File')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cough_app.doctor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='suggestion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cough_app.schedule')),
